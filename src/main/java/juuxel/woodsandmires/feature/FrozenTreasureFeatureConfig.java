...
public record FrozenTreasureFeatureConfig(
    ...
    public static final Codec<FrozenTreasureFeatureConfig> CODEC = RecordCodecBuilder.create(builder ->
        builder.group(
            ...
            IntProviders.POSITIVE_CODEC.fieldOf("height").forGetter(FrozenTreasureFeatureConfig::height),
            IntProviders.POSITIVE_CODEC.fieldOf("radius").forGetter(FrozenTreasureFeatureConfig::radius),
